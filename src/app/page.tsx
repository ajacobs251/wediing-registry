    ...
    <div className="page-shell">
      ...
      <section className="section">
        <div className="section-heading">
          <h2>Our Story</h2>
          <p className="eyebrow">Makenzie and Alex met in July of 2024 and have been inseparable since. Their love of music and adventure together united them and in that same spirit they have explored and built their life together. From traveling to see cowboys together to hosting parties there is nothing they can&apos;t do. The world is big but finding each other made it feel small. Like it was meant to be.</p>
          <p className="eyebrow">Makenzie works as an Underwriter and Alex works as a Software Engineer. They have shared each other&apos;s worlds and dreams and have only seen happiness and hope in each other. Each of them are gifted in music and art and love to show it everyone when they can. This will be seen in the self-made invitations and website as well as the heartfelt music curation. Everything you will see and experience will reflect their unique bond and shared passions.</p>
        </div>
      </section>
